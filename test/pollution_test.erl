...
add_value_fail_test() ->
  M = pollution:add_station("Stacja 1", {1,1}, pollution:create_monitor()),
  Time = calendar:local_time(),
  M2 = pollution:add_value("Stacja 1", Time, "PM10", 46.3, M),
  ?assertNotMatch({error, _}, M2),
  ?assertMatch({error, _}, pollution:add_value("Stacja 1", Time, "PM10", 46.3, M2)),
  ?assertMatch({error, _}, pollution:add_value("Stacja 1", Time, "PM10", 36.3, M2)),
  ?assertMatch({error, _}, pollution:add_value({1,1}, Time, "PM10", 46.3, M2)),
  ?assertMatch({error, _}, pollution:add_value({1,1}, Time, "PM10", 36.3, M2)).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
get_daily_mean_test() ->
  M = pollution:add_station("Stacja 3", {3,3},
    pollution:add_station("Stacja 2", {2,2},
      pollution:add_station("Stacja 1", {1,1},
